...
function xhs($url)
{
    ...
    if (preg_match($pattern, $response, $matches)) {
        ...
        if ($decoded) {
            ...
            $videoH265Url = $videoH265Url ?: safeGet($decoded, ['note', 'noteDetailMap', $id, 'note', 'video', 'media', 'stream', 'h265', 0, 'masterUrl']);
            ...
            $cover = $cover ?: safeGet($decoded, ['note', 'noteDetailMap', $id, 'note', 'imageList', 0, 'infoList', 0, 'url'], '');
